package com.swisscom.fabric;

import com.swisscom.fabric.config.*;
import com.swisscom.fabric.controller.SdkController;
...
public class FabricApplication {
	...
	@Bean
	public CommandLineRunner initFabric(ApplicationContext ctx) {
		return args -> {
			System.out.println("╔═╗┌─┐┌┐ ┬─┐┬┌─┐  ╔╗ ┌─┐┌─┐┌┬┐┌─┐┌┬┐┬─┐┌─┐┌─┐\n" +
							   "╠╣ ├─┤├┴┐├┬┘││    ╠╩╗│ ││ │ │ └─┐ │ ├┬┘├─┤├─┘\n" +
							   "╚  ┴ ┴└─┘┴└─┴└─┘  ╚═╝└─┘└─┘ ┴ └─┘ ┴ ┴└─┴ ┴┴  ");
