...
//                    DEFAULT_CONFIG));
            ...
            defaultProperty(INTEGRATIONTESTS_ORG + "peerOrg1.peer_locations", "peer0.org1.example.com@grpc://172.17.0.1:7051");
            defaultProperty(INTEGRATIONTESTS_ORG + "peerOrg1.orderer_locations", "orderer.example.com@grpc://172.17.0.1:7050");
            ...
            defaultProperty(INTEGRATIONTESTS_ORG + "peerOrg1.eventhub_locations", "peer0.org1.example.com@grpc://172.17.0.1:7053");
    ...
    public String getTestChannlePath() {
        ...
        return "/var/egabb/fixtures/e2e-2Orgs/channel";
