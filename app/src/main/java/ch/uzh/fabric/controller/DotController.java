...
public class DotController {
    ...
    public String registration(Model model,
        ...
        try {
            registrationProposals = dotService.getRegistrationProposals(username, role);
    ...
    public String registrationAccept(RedirectAttributes redirAttr,
        ...
        try {
            dotService.register(owner, role, vin);
        } catch (Exception e) {
    ...
    public String confirm(Model model,
        ...
        try {
            carsToConfirm = dotService.getCarsToConfirm(username, role);
        } catch (Exception e) {
            error = e.getMessage();
        }
    ...
    public String confirmationAccept(RedirectAttributes redirAttr,
        ...
        try {
            dotService.confirm(username, role, vin, numberplate);
        } catch (Exception e) {
            redirAttr.addAttribute("error", e.getMessage());
    ...
    public String revocation(Model model,
        ...
        try {
            Map<String, String> revocationProposals = dotService.getRevocationProposals(username, role);
    ...
    public String revocationAccept(RedirectAttributes redirAttr, Authentication auth, @RequestParam String vin, @RequestParam String owner) {
        ...
        try {
            dotService.revoke(owner, role, vin);
        } catch (Exception e) {
            redirAttr.addAttribute("error", e.getMessage());
    ...
    public String allCars(RedirectAttributes redirAttr, Authentication auth, Model model) {
        ...
        try {
            cars = dotService.getAllCars(username, role);
        } catch (Exception e) {
