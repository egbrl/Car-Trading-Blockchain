...
type KeyringEntry struct {
    PublicKey      [32]byte          `json:"public_key"`          // key to lock car
    PrivateKey     [32]byte          `json:"private_key"`         // key to unlock car
    CarTs          int64             `json:"car_ts"`              // car ts to find actual car
}
